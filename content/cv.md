...
- **目标岗位**：员工福利产品策划运营 / 雇主品牌 / 企业活动策划
- **个人定位**：懂目标人群、会策划落地、能内容共创的策划型人才
...
### 用 Codex 开发的量化金融 iOS App —— AI 编程实践
*2026* · AI 工具 · 量化金融

- 尝试量化金融方向，用 AI 编程工具 Codex 安装金融 skills 开发 iOS App，完成需求拆解、代码生成与调试全流程
- 目前正使用东方财富模拟盘对 App 的交易策略进行尝试与调整
- 非计算机背景，用 AI Agent 把量化想法落地为真实产品，探索"AI 工具 × 金融 × 内容创意"跨界能力
...
- **AI 编程 × 量化金融**：用 Codex 开发量化金融 App，使用东方财富模拟盘验证交易策略（探索中）
